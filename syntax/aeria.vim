...
" Properties
syn region aeriaProperties matchgroup=aeriaPropertiesDelim start=/\v<(properties|additionalProperties)\s*\{/ end=/}/ contains=aeriaComment,@aeriaConstant,aeriaPropertiesColumn,aeriaPropertyName transparent
...
syn cluster aeriaPropertyTypeCluster contains=aeriaPropertyType,aeriaPropertyIdentifier
syn match aeriaPropertyName /\v\w+/ nextgroup=@aeriaPropertyTypeCluster skipwhite
...
syn region aeriaCollection matchgroup=aeriaCollectionDelim start=/\v<collection\s+\w*\s*\{/ end=/}/ contains=aeriaComment,@aeriaConstant,aeriaProperties,aeriaKeyedList,aeriaCollectionModifierName,aeriaCollectionSearch transparent
